<x-app-layout>
    <div class="py-6 px-4 md:px-0 space-y-10">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div>
                <h2 class="text-3xl md:text-4xl font-black text-white uppercase tracking-tighter">Console <span class="text-blue-600">Admin</span></h2>
            ...
            <div class="text-left md:text-right w-full md:w-auto border-t md:border-t-0 border-white/5 pt-4 md:pt-0">
                <p class="text-white font-black text-lg md:text-xl uppercase italic">{{ now()->translatedFormat('d F Y') }}</p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {{-- Effectif --}}
            <div class="bg-gray-900 p-6 rounded-[2rem] md:rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                <p class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4">Collaborateurs</p>
                <h3 class="text-4xl md:text-5xl font-black text-white group-hover:text-blue-500 transition-colors">{{ $totalUsers }}</h3>
            ...
            <div class="bg-gray-900 p-6 rounded-[2rem] md:rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                ...
                <h3 class="text-4xl md:text-5xl font-black text-emerald-500">{{ $attendanceToday }}</h3>
            ...
            <div class="bg-gray-900 p-6 rounded-[2rem] md:rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden group">
                ...
                <h3 class="text-4xl md:text-5xl font-black {{ $pendingLeaves > 0 ? 'text-orange-500' : 'text-white' }}">{{ $pendingLeaves }}</h3>
            ...
            {{-- Performance Globale --}}
            <div class="bg-gray-900 p-6 rounded-[2rem] md:rounded-[2.5rem] border border-white/5 shadow-2xl relative overflow-hidden group border-b-4 border-b-blue-600">
                <p class="text-[10px] font-black text-gray-500 uppercase tracking-widest mb-4">Performance Moyenne</p>
                <h3 class="text-4xl md:text-5xl font-black text-white">{{ number_format($globalPerformance, 1) }}<span class="text-sm text-gray-600">/9</span></h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8 bg-gray-900 rounded-[2rem] md:rounded-[3rem] border border-white/5 overflow-hidden shadow-2xl">
                <div class="p-6 md:p-8 border-b border-white/5 flex justify-between items-center">
                    <h3 class="text-white font-black uppercase text-[10px] md:text-sm tracking-widest italic">Statut des équipes</h3>
                    <span class="px-3 py-1 bg-emerald-500/10 text-emerald-500 text-[9px] md:text-[10px] font-black rounded-full border border-emerald-500/20">LIVE</span>
                </div>
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse min-w-[500px]">
                        <thead>
                            <tr class="bg-slate-950/50">
                                <th class="p-4 md:p-6 text-[10px] font-black text-gray-500 uppercase">Employé</th>
                                <th class="p-4 md:p-6 text-[10px] font-black text-gray-500 uppercase">Département</th>
                                <th class="p-4 md:p-6 text-[10px] font-black text-gray-500 uppercase text-center">Présence</th>
                                <th class="p-4 md:p-6 text-[10px] font-black text-gray-500 uppercase text-right">Action</th>
                            </tr>
                        </thead>
                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors group">
                                <td class="p-4 md:p-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-xs font-black text-white uppercase truncate max-w-[100px] md:max-w-none">{{ $emp->name }}</span>
                                    </div>
                                </td>
                                <td class="p-4 md:p-6">
                                ...
                                <td class="p-4 md:p-6 text-center">
                                    @if($emp->attendances->isNotEmpty())
                                        <span class="px-2 py-1 bg-emerald-500/10 text-emerald-500 text-[8px] font-black rounded-lg border border-emerald-500/20 uppercase">Présent</span>
                                    @else
                                        <span class="px-2 py-1 bg-red-500/10 text-red-500 text-[8px] font-black rounded-lg border border-red-500/20 uppercase">Absent</span>
                                    @endif
                                </td>
                                <td class="p-4 md:p-6 text-right">
                                    <a href="{{ route('users.index') }}" class="text-gray-600 hover:text-blue-500">
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="bg-slate-950 p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] border border-white/5 shadow-2xl">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative pl-6 border-l border-blue-600/30 group">
                            ...
                            <p class="text-xs font-bold text-gray-300 leading-tight">{{ $mission->title }}</p>
                ...
                {{-- QUICK LINKS --}}
                <div class="bg-gray-900 p-4 md:p-6 rounded-[2rem] border border-white/5 grid grid-cols-2 gap-4">
                    <a href="{{ route('payroll.index') }}" class="p-4 bg-slate-950 rounded-2xl border border-white/5 hover:border-blue-500/50 transition-all text-center group">
                        ...
                        <span class="text-[8px] font-black text-gray-500 uppercase tracking-tighter">Paie</span>
                    </a>
                    <a href="{{ url('/evaluations') }}" class="p-4 bg-slate-950 rounded-2xl border border-white/5 hover:border-blue-500/50 transition-all text-center group">
                        ...
                        <span class="text-[8px] font-black text-gray-500 uppercase tracking-tighter">Évals</span>
                    </a>
                </div>
            </div>
        </div>
