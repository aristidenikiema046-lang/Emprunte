                        ...
                        <div class="bg-gray-900 p-6 rounded-[2.5rem] border border-white/5 hover:border-blue-500/30 transition-all shadow-xl group">
                            <div class="flex justify-between items-start mb-6">
                                ...
                                <div class="text-right">
                                    ...
                                    <span class="text-[8px] px-2 py-0.5 rounded bg-blue-600/10 text-blue-500 font-black uppercase tracking-tighter">Score Auto</span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <div class="w-full bg-slate-950 h-2 rounded-full overflow-hidden border border-gray-800">
                                        <div class="bg-gradient-to-r from-blue-600 to-indigo-500 h-full shadow-[0_0_15px_rgba(37,99,235,0.4)] transition-all duration-1000" 
                                             style="width: {{ ($eval->total_score / 9) * 100 }}%"></div>
                                    </div>
                                </div>
                            </div>

                            <div class="mt-6 pt-4 border-t border-white/5 flex justify-between items-center text-[8px] font-black uppercase text-gray-600 italic">
                                <span>Audit ID: #{{ $eval->id }}</span>
                                <span class="text-emerald-500 flex items-center gap-1">
                                    <i class="fa-solid fa-circle-check"></i> Calculé avec succès
                                </span>
                            </div>
                        </div>
                        @empty
