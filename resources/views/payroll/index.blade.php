        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 {{ auth()->user()->role === 'admin' ? 'lg:grid-cols-3' : '' }} gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-gray-900 border border-gray-800 p-6 md:p-8 rounded-[2.5rem] shadow-2xl lg:sticky lg:top-6">
                ...
                <div class="{{ auth()->user()->role === 'admin' ? 'lg:col-span-2' : 'lg:col-span-3' }}">
                    <div class="bg-gray-900 border border-gray-800 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl overflow-hidden">
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse min-w-[600px]">
                                <thead class="bg-gray-950/50">
                                    <tr>
                                        @if(auth()->user()->role === 'admin') 
                                            <th class="px-6 md:px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">Collaborateur</th> 
                                        @endif
                                        <th class="px-6 md:px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">Période</th>
                                        <th class="px-6 md:px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">Montant Net</th>
                                        <th class="px-6 md:px-8 py-6 text-[10px] font-black text-gray-500 uppercase tracking-widest">État</th>
                                        <th class="px-6 md:px-8 py-6 text-center text-[10px] font-black text-gray-500 uppercase tracking-widest">Archive</th>
                                        @if(auth()->user()->role === 'admin') 
                                            <th class="px-6 md:px-8 py-6 text-right text-[10px] font-black text-gray-500 uppercase tracking-widest">Actions</th> 
                                        @endif
                                    </tr>
                                </thead>
                                    ...
                                    <tr class="hover:bg-gray-800/20 transition-all group">
                                        ...
                                        <td class="px-6 md:px-8 py-6">
                                            <div class="flex items-center gap-3">
                                                <div class="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center text-[10px] font-black text-emerald-500 border border-gray-700 shrink-0">
                                                    {{ substr($payroll->user->name, 0, 2) }}
                                                </div>
                                                <span class="font-bold text-white text-sm truncate max-w-[120px]">{{ $payroll->user->name }}</span>
                                            </div>
                                        </td>
                                        @endif
                                        <td class="px-6 md:px-8 py-6">
                                        ...
                                        <td class="px-6 md:px-8 py-6">
                                            <span class="font-mono font-bold text-emerald-500 text-base whitespace-nowrap">
