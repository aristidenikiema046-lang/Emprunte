                    ...
                    <div class="space-y-4">
                        <template x-for="(option, index) in options" :key="index">
                            <div class="flex gap-3">
                                <input type="text" name="options[]" required class="flex-1 bg-gray-950 border border-gray-800 rounded-xl px-5 py-4 text-white focus:border-indigo-500 transition-all font-bold text-sm" placeholder="Entrez une option">
                                <button type="button" @click="if(options.length > 2) options.splice(index, 1)" class="w-14 h-14 rounded-xl bg-gray-950 border border-gray-800 text-rose-500 hover:bg-rose-500/10 transition-all">
