...
Route::middleware('auth')->group(function () {
    ...
    // --- Profil (Mis à jour avec la route 'show' pour ton nouveau design) ---
    Route::get('/profile/view', [ProfileController::class, 'show'])->name('profile.show'); // Ton nouveau design
    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit');     // Formulaire d'édition
